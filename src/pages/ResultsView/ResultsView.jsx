        ...
        <StyledResultsView>
            <div>
                ...
                <div className="player-result">
                    {definePlayerStatus && <p style={{color: definePlayerStatus.color}}>{definePlayerStatus.text}</p>}
                </div>
                <section className="controls">
                    <button type="button" onClick={() => {
                        history.push('/')
                        dispatch(resetGame())}}>Play Again</button><button type="button" onClick={handleNewGame}>New game</button>
                </section>
            </div>
        </StyledResultsView>
    )
